        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden shadow-2xl  w-2xl mt-40"
            >
              <button
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-5 text-center">
                ...
                {tableOf === 1 && (
                  <button
                    onClick={onBack}
                    className="mt-3 px-6 py-2 bg-primary text-black font-black text-xl rounded-xl hover:opacity-90 transition"
                  >
                    🏠 Back to Home
                  </button>
                )}
