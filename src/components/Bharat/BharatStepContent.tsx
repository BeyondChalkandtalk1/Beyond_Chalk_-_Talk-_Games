...
//           <p className="text-muted-foreground font-body text-sm">
//             {/* Read the statement carefully 📖 */}
//             Read the sentence carefully – it says “{content?.arrayRows} are”, not “za”
//           </p>
//         </div>
//       );
...
//           </motion.div>
//           <p className="text-muted-foreground font-body text-sm text-center max-w-md">
//             We add {multipliedBy} two times. That makes {tableOf}! 
//             {/* <span className="font-semibold"></span> a total of{" "}
//             <span className="font-semibold">{tableOf}</span> times. */}
//           </p>
//         </div>
//       );
