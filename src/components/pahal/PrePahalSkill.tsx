...
// const PrePahalSkill = ({ onComplete }: Props) => {
//   // Sub-phase: representation first, then quiz
...
//                   <div
//                     key={i}
//                     className={`h-2 flex-1 rounded-full transition-colors ${i < stepIndex ? "bg-game-done" : i === stepIndex ? "bg-game-active" : "bg-muted"}`}
//                   />
//                 );
//               })}
//             </div>
...
//                     exit={{ opacity: 0, x: -30 }}
//                     transition={{ duration: 0.25 }}
//                     className="bg-card/90 backdrop-blur-sm rounded-xl border border-border p-8 md:p-12 game-card-shadow flex flex-col items-center"
//                   >
//                     <img
//                       src={current.image}
//                       alt={current.label}
...
//                 <span className="text-sm font-display font-semibold text-game-done">
//                   Score: {score}
//                 </span>
//                 <span
//                   className={`flex items-center gap-1 text-sm font-display font-semibold ${timeLeft <= 5 ? "text-destructive animate-pulse" : "text-muted-foreground"}`}
//                 >
...
//                     <>
//                       <p className="text-xl font-display font-bold text-foreground text-center mb-6">
//                         {question.question}
//                       </p>
