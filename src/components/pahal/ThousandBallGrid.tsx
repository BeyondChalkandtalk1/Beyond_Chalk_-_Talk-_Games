...
// interface Props {
//   totalVisible?: number; // 0–1000, kitne balls dikhne chahiye
//   ballSize?: number; // px mein ball size (default 24)
// }

// /**
//  * 1000 balls — 10 layers × 10×10 grid
//  * Layer 0 = bottom (pehle dikhti hai), Layer 9 = top
//  * Perspective 3D tilt se cube jaisa lagta hai
//  */
// const ThousandBallGrid = ({ totalVisible = 1000, ballSize = 14 }: Props) => {
//   const COLS = 10;
//   const ROWS = 10;
//   const LAYERS = 10;
//   const gap = 0.5; // px
...
//           position: "relative",
//           width: COLS * (ballSize + gap),
//           height: ROWS * (ballSize + gap),
//         }}
//       >
//         {Array.from({ length: LAYERS }, (_, layerIndex) => {
//           const zOffset = layerIndex * (ballSize + gap);
...
//                       stiffness: 400,
//                       damping: 12,
//                       // Layer ke andar delay + layer ka offset
