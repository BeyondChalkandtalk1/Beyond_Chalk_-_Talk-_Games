...
// import turnPageSound from "../assets/turning-page.mpeg";
...
//     text: "One bright morning, a young girl decided to make something special — her very own calendar! 📅 She brought colourful papers, sketch pens, and shiny stickers. Carefully, she designed each page with days and dates.",
//     highlight:
//       "But one important thing was still missing — the names of the months!",
//     emoji: "✏️",
//     imagePosition: "left" as const,
//   },
//   {
...
//     text: "After a little chase, she finally managed to collect all the sheets. But now there was a new problem... 😟",
//     highlight:
//       "All the pages were completely mixed up! The months were no longer in order.",
//     emoji: "😰",
//     imagePosition: "right" as const,
//   },
//   {
...
//     const audio = new Audio(turnPageSound);
//     audio.currentTime = 0;
//     audio.play().catch(() => {});
//   }, []);
...
//       // Play turning sound — har baar naya Audio object banao taaki ek se zyada baar bhi chale
//       const audio = new Audio(turnPageSound);
//       audio.currentTime = 0;
//       audio.play().catch(() => {});
...
//           ) : (
//             <>
//               <span className="text-xl">Turn Page</span>{" "}
...
// import whitePaw from "../assets/whitePaw.png";
// import turnPageSound from "../assets/turning-page.mpeg";
// import TTOPageSound from "../assets/tapToOpenSound.mpeg";
// import { useSound } from "@/contexts/SoundContext";
// import storyBg from "../assets/storyBg.mp4";
...
const CalendarStoryIntro = ({ onStart }: { onStart: (story: any) => void }) => {
  ...
  if (bookState === "closed" || bookState === "opening") {
    return (
      // ✅ position: fixed video ke liye outer wrapper pe overflow:hidden + relative
      <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
        {/* ✅ Video poori screen pe — fixed + z-0 */}
        <video
          src={storyBg}
          autoPlay
          loop
        ...
        <p
          className="mt-6 font-body text-white/80 text-xs md:text-sm"
          style={{ zIndex: 10, position: "relative" }}
        >
          Click the book to start reading!
        </p>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4 relative overflow-hidden">
      ...
      {/* Saara content z-10 pe */}
      <div
        className="relative w-full flex flex-col items-center"
        style={{ zIndex: 10 }}
      >
        <h2 className="font-display text-xl md:text-2xl font-bold text-white drop-shadow mb-3">
          🐾 Paw Patch Calendar Quest
        </h2>
